...
<title>Kreiranje novog templejta</title>
</head>
<body>
	<div class="header">
	  <h1>Odabir/kreiranje novog templejta</h1>
	...
	<form action="dodajTemplejt" method="post">
	  ...
	  <br>
	  <input class="submitclass" type="submit" value="Sacuvaj templejt i kreiraj atribute">
	 </form>
